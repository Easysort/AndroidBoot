...
case "$APP" in
  ...
  video) SCRIPT_PATH="$HOME/AndroidBoot/applications/video/tmux-starter.sh" ;;
...
termux-job-scheduler --job-id 700 --script "$SCRIPT_PATH" --period-ms 900000 --persisted true --network any